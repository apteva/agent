...
func TestFileDiscovery_GetAgentsReturnsDiscoveredAgents(t *testing.T) {
	...
	coordDiscovery, err := NewFileDiscovery(cfg, "coordinator-id", "Coordinator", "A coordinator agent", "http://localhost:4106", nil, nil)
	if err != nil {
...
func TestFileDiscovery_SameInstanceUsedForDiscoveryAndGetAgents(t *testing.T) {
	...
	discovery, err := NewFileDiscovery(cfg, "test-agent", "Test Agent", "A test agent", "http://localhost:4000", nil, nil)
	if err != nil {
...
func TestFileDiscovery_WorkerModeDoesNotDiscover(t *testing.T) {
	...
	workerDiscovery, err := NewFileDiscovery(cfg, "worker-id", "Worker", "A worker agent", "http://localhost:4105", nil, nil)
	if err != nil {
...
func TestFileDiscovery_GroupFiltering(t *testing.T) {
	...
	discovery, err := NewFileDiscovery(cfg, "agent-a", "Agent A", "Agent A description", "http://localhost:4000", nil, nil)
	if err != nil {
		t.Fatalf("Failed to create discovery: %v", err)
	}
...
func TestFileDiscovery_ViaInterface(t *testing.T) {
	...
	discoveryService, err = NewDiscoveryService(cfg, "interface-agent", "Interface Agent", "An interface test agent", "http://localhost:4000", nil, nil)
	if err != nil {
...
func TestFileDiscovery_InitialDiscoveryRunsBeforeStartReturns(t *testing.T) {
	...
	discovery, err := NewFileDiscovery(cfg, "new-agent", "New Agent", "A new agent", "http://localhost:4000", nil, nil)
	if err != nil {
		t.Fatalf("Failed to create discovery: %v", err)
	}
